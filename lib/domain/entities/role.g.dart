...
extension RoleByIndex on IsarCollection<Role> {
  ...
  Role? getByNameSync(String name) {
  ...
  Future<List<Role?>> getAllByName(List<String> nameValues) {
    final values = nameValues.map((e) => [e]).toList();
    return getAllByIndex(r'name', values);
  }

  List<Role?> getAllByNameSync(List<String> nameValues) {
    final values = nameValues.map((e) => [e]).toList();
  ...
  Future<Id> putByName(Role object) {
    return putByIndex(r'name', object);
  }

  Id putByNameSync(Role object, {bool saveLinks = true}) {
    return putByIndexSync(r'name', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByName(List<Role> objects) {
    return putAllByIndex(r'name', objects);
  }

  List<Id> putAllByNameSync(List<Role> objects, {bool saveLinks = true}) {
...
extension RoleQueryWhere on QueryBuilder<Role, Role, QWhereClause> {
  ...
  QueryBuilder<Role, Role, QAfterWhereClause> nameEqualTo(String name) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Role, Role, QAfterWhereClause> nameNotEqualTo(String name) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
