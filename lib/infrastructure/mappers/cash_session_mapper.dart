...
class CashSessionMapper {
  static CashSessionModel cashSessionToCashSessionModel(CashSession cashSession) {
  ...
  static CashSession cashSessionModelToCashSession(CashSessionModel cashSessionModel) {
    return CashSession()
